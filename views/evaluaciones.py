...
def mostrar(supabase):
 ...
 #       icons=["bar-chart-line", "clipboard-check"],
    ...
    if seleccion == "📊 INDICADORES":
        ...
        # Crear una barra vacía y llenarla progresivamente
        steps = 20
        for i in range(1, steps + 1):
            step_ing = int(ingresantes * i / steps)
            step_no_ing = int(no_ingresantes * i / steps)
            ...
            fig_ing.add_trace(go.Bar(
                ...
                marker_color='#A19AD3',
                orientation='h',
                customdata=[[step_no_ing, pct_no_ing]],
